# -*- coding: utf-8 -*-
"""
Created on Wed Nov 24 11:27:58 2021
https://github.com/AlbertoLanaro/ImagePatchExtractor/blob/master/patch_extractor.py
@author: rajgudhe
"""
...
def main():
    ...
    parser.add_argument('-i',
                        ...
                        default = 'data/CryoNuSeg/images',
                        )
    parser.add_argument('-m',
                        '--input_masks_path',
                        help='Path to image masks',
                        type=str,
                        default='data/CryoNuSeg/masks')
